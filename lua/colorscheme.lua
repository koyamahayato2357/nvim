...
hi("PmenuSel", { bg = sendai.blue })
hi("Search", { fg = sendai.navy, bg = sendai.cream })

hi("Boolean", { fg = sendai.brick })
...
hi("Repeat", { fg = sendai.cream })
hi("Special", { fg = sendai.gold })
...
hi("Substitute", { fg = sendai.navy, bg = sendai.cream })
